...
sys.path.append(os.path.sep.join([os.getcwd(), folder]))
...
class LeptonCamera:
    ...
    def capture(
        ...
        seconds: Tuple[float, int, None] = None,
    ) -> None:
        """
...
class RecordingWidget(qtw.QWidget):
    ...
    def __init__(self) -> None:
        ...
        # rec button
        path = os.getcwd()
        rec_file = os.path.sep.join([path, "contents", "rec.png"])
...
class LeptonWidget(qtw.QMainWindow):
    ...
    def __init__(
        ...
        # camera rotation
        rotation_icon_path = [self.path, "contents", "rotation.png"]
        ...
        # icon and title
        icon = os.path.sep.join([self.path, "contents", "main.png"])
